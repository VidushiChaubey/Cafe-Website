    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Accepted', 'Accepted'), ('Making', 'Making'), ('On The Way', 'On The Way'), ('Served', 'Served'), ('Cancel', 'Cancel'), ('Pending', 'Pending')], default='Pending', max_length=50)),
